...
1. **Scripture** — the canonical fixed text. Veil = 0 (mechanism fully disclosed), Pull = 0 (does not respond to engagement), Grip = 0 (voluntary participation bounded by ritual structure). Pe = 0.
2. **Gutenberg (early print)** — constrained information reproduction. Historical Pe record.
3. **The Tapes** — raw recorded testimony. No algorithm. No engagement optimization. Unmediated.
...
Signs of a Geto-type Binder:
- Apostle and Godhand cards accumulated but no corresponding ICC weight reduction in those domains
- VP rising alongside Binder size
- Scores accurate but producing no Pe reduction in the domains scored
...
*Back to: [Mechanics](index.md) · [Abilities](abilities.md) · [Game Loops](game-loops.md)*
